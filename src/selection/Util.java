...
public class Util {
	 ...
	 * 
	 */
	public static void initialiseListCompetitors() {
		competitors = new ArrayList<Competitor>();
	}
	
	/**
	 * 
	 * @param nbOfCompetitors
	 * @return
	 */
	public static List<Competitor> createCompetitors(int nbOfCompetitors) {
			
			initialiseListCompetitors();
