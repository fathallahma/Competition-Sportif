...
public abstract class Competition {
	...
	protected Set<Match> setMatches;
	// The played matches 
	...
	public Competition(List<Competitor> competitors, Match match){
		...
		this.match = match;
		this.setMatches = new HashSet<Match>();
	...
	public synchronized void addCompetitionListener(CompetitionListener l) {
		if (!competitionObservers.contains(l)) {
	...
	/** 
	 * returns the list of observers of the competition
	 * @return a list of observers
	 */
	public List<CompetitionListener> getCompetitionObservers() {
	 ...
	 */
	public void play() {
		this.organiseMatches(competitors);
	 ...
	 * @param competitors the list of the competitors
	 */
	protected abstract void organiseMatches(List<Competitor> competitors);
	...
	public Map<Competitor, Integer> ranking(){
		...
		System.out.println("\t\t     *** " + this.description() + " RANKING ***");
		System.out.println("*****************************************************************\n");
